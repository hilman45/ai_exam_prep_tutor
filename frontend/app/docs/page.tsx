        ...
        return (
          <div className="space-y-6 animate-fadeIn">
            ...
            <div className="space-y-6">
              ...
              {/* PrepWise overview image */}
              <div className="mt-8 rounded-xl overflow-hidden shadow-sm border border-gray-100">
                <img
                  src="/prepwise-overview.svg"
                  alt="PrepWise overview - study with spaced repetition and active recall"
        ...
        return (
          <div className="space-y-6 animate-fadeIn">
            ...
            <div className="space-y-6">
              ...
              {/* Target Users Image (generated) */}
              <div className="mt-8 rounded-xl overflow-hidden shadow-sm border border-gray-100">
                <img
                  src="/target-users.png"
                  alt="Diverse group of students and professionals using PrepWise"
                  className="w-full h-auto object-contain"
                />
              </div>
            </div>
            ...
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="space-y-6">
                ...
                <div className="mt-6 rounded-xl overflow-hidden shadow-sm border border-gray-100">
                  <img
                    src="/notes-feature.svg"
                    alt="Notes feature - upload and manage study notes"
                    className="w-full h-auto object-contain"
                  />
                </div>
              </div>
          ...
          return (
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="space-y-6">
                ...
                <div className="mt-6 rounded-xl overflow-hidden shadow-sm border border-gray-100">
                  <img
                    src="/flashcards-feature.svg"
                    alt="Flashcards feature - study with spaced repetition"
                    className="w-full h-auto object-contain"
                  />
                </div>
              </div>
